...
| 5. Docs + version | 12–14 | README, start-building, api, changelog, example READMEs, write-device-skill SKILL.md, version bump |
| 6. Final sweep | 15 | Grep for residual references; fix any stragglers |
...
## Task 14: Update changelog + bump version to 0.5.0
...
Mechanical in most cases. See the example-project commits in this release
